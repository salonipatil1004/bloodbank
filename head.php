...
a.act{
background: linear-gradient(to right, #B3CEE5 0%, #f7cac9 100%);
color: black;
border-radius:30px;
}
a.logo2{
...
<body>
  <div class="header">
    <a href="home.php" class="logo"<?php if($active=='home') echo "class='logo2'"; ?>>Blood Buddies </a>
    <div class="header-right">
     <a href="donate_blood.php"  <?php if($active=='donate') echo "class='act'"; ?>>Become A Donor</a>
      <a href="need_blood.php" <?php if($active=='request') echo "class='act'"; ?>>Need Blood</a>
