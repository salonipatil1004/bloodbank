...
<br>
        <h1 style="text-align:center;font-size:45px;">BloodBank Management System</h1>
<br>
        <div class="row">
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header card bg-info text-white" >The need for blood</h4>
                        ...
                        <p class="card-body overflow-auto" style="padding-left:2%;height:370px;text-align:left;">
                          <?php
                            include 'conn.php';
